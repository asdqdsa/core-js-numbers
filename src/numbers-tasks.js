...
// function getAverage-test(/* value1, value2 */) {
// let [num1, num2] = [value1, value2];
// if (!Number.isFinite(num1)) num1 = 0;
...
function getAngleBetweenVectors(x1, y1, x2, y2) {
  ...
  const subAngle = dotProduct / (magnitudeVector1 * magnitudeVector2);
  return Math.acos(subAngle);
}
...
function isPowerOfTwo(num) {
  return Number.isInteger(Math.log2(num) % 2);
}
